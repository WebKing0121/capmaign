...
export class ConfigurationComponent implements OnInit {
  ...
  scroll = (): void => {
    if (this.headerFixedLayout === false) {
      (document.querySelector('#nav-ps-pangong') as HTMLElement).style.maxHeight = 'calc(100vh)';
  ...
  changeMenuFixedLayout(flag) {
    setTimeout(() => {
      if (flag) {
        ...
        if (this.nextConfig.layout === 'vertical') {
          (document.querySelector('#nav-ps-pangong') as HTMLElement).style.maxHeight = 'calc(100vh - 56px)'; // calc(100vh - 70px) amit
        }
        ...
        if (this.nextConfig.layout === 'vertical') {
          (document.querySelector('#nav-ps-pangong') as HTMLElement).style.maxHeight = 'calc(100%)'; // calc(100% - 70px) amit
        }
        if (this.nextConfig.layout === 'vertical') {
