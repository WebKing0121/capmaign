...
export class AutomationsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    const columns: DataTableColumn[] = [
      ...
      { name: 'Type', prop: 'type', sortable: true, custom: true, template: this.templateType },
  ...
  getAutomationType(value: string) {
    return this.automationTypeList.find(x => x.value === value).label;
  }
}
